...
public:
	...
	static bool IO_I_SocketState_PCB_Gripper_On();
	static bool IO_I_SocketState_PCB_Gripper_Off();
	static bool IO_I_SocketState_PCB_Gripper_Up();
	static bool IO_I_SocketState_PCB_Gripper_Down();
	static bool IO_I_LensCoverPush_Sylinder_Up();
	static bool IO_I_LensCoverPush_Sylinder_Down();
	static bool IO_I_FlimGripper_For(__in int nSelect);
	static bool IO_I_FlimGripper_Back(__in int nSelect);
	static bool IO_I_FlimGripper_On(__in int nSelect);
	static bool IO_I_FlimGripper_Off(__in int nSelect);
	static bool IO_I_FlimGripper_Cover_On(__in int nSelect);
	static bool IO_I_FlimGripper_Cover_Off(__in int nSelect);
	static bool IO_I_FlimGripper_Film_Box_Dtc(__in int nSelect);
	static bool IO_I_SocketState_Film_Box_Dtc(__in int nSelect);
	static bool IO_I_SocketState_Work_Zone_Dtc();
	static bool IO_I_SocketState_PCB_Dtc();
	...
	static bool IO_O_SocketState_PCB_Gripper_On(bool bCheckStatus = true);
	static bool IO_O_SocketState_PCB_Gripper_Off(bool bCheckStatus = true);
	static bool IO_O_SocketState_PCB_Gripper_Up(bool bCheckStatus = true);
	static bool IO_O_SocketState_PCB_Gripper_Down(bool bCheckStatus = true);
	static bool IO_O_LensCoverPush_Sylinder_Up(bool bCheckStatus = true);
	static bool IO_O_LensCoverPush_Sylinder_Down(bool bCheckStatus = true);
	static bool IO_O_FlimGripper_For(__in int nSelect, bool bCheckStatus = true);
	static bool IO_O_FlimGripper_Back(__in int nSelect, bool bCheckStatus = true);
	static bool IO_O_FlimGripper_On(__in int nSelect, bool bCheckStatus = true);
	static bool IO_O_FlimGripper_Off(__in int nSelect, bool bCheckStatus = true);
	static bool IO_O_FlimGripper_Cover_On(__in int nSelect, bool bCheckStatus = true);
	static bool IO_O_FlimGripper_Cover_Off(__in int nSelect, bool bCheckStatus = true);
	static void IO_O_FlimGripper_Air_Blow(__in int nSelect, __in bool bOn);
