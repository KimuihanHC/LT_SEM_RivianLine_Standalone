...
CSeqIntrinsic30::CSeqIntrinsic30()
{
...
void CSeqIntrinsic30::Initialize_Startup(__in UINT nIdx, __in int nCapture)
{
	switch (nIdx)
	{
	case 0:
...
void CSeqIntrinsic30::Finalize_Startup(__in enMCErrCode err, __in int nIdx, __in int nCapture)
{
...
UINT CSeqIntrinsic30::StartOperation_Startup()
{
	auto err = MCEC_OK;
...
UINT CSeqIntrinsic30::StartOperation_Run()
{
	TESTER_COMM		stTester		= *DATAMANAGER->GetCurrentTesterCommData();
...
UINT CSeqIntrinsic30::Maintence(__in enMaintFunId id)
{
	auto err = 0;
	switch (id)
	{
...
void CSeqIntrinsic30::SetInspectionStep()
{
	SetStep(SEQ_STEP_DISTORTION_INSPECTION_PREVIEW_STOP);
}

void CSeqIntrinsic30::ResetStepFlag()
{
...
void CSeqIntrinsic30::RestartStep()
{
	switch (GetStep())
	{
	case SEQ_STEP_DISTORTION_READY:
...
bool CSeqIntrinsic30::ReadyToStart()
{
	auto bRet = false;
...
bool CSeqIntrinsic30::IsStep_Ready()
{
	return GetStep() == SEQ_STEP_DISTORTION_READY;
}

bool CSeqIntrinsic30::IsStep_WaitForPushSwitch()
{
	return GetStep() == SEQ_STEP_DISTORTION_WAIT_STOP_SWITCH_PUSH;
}

bool CSeqIntrinsic30::IsStep_UnderMoveY()
{
	return GetStep() < SEQ_STEP_DISTORTION_INSPECTION_PREVIEW_START;
}

bool CSeqIntrinsic30::IsStep_BeforePushStopSwitch()
{
	return GetStep() < SEQ_STEP_DISTORTION_WAIT_STOP_SWITCH_PUSH;
}

bool CSeqIntrinsic30::IsStep_NotStartupModeWait()
{
	return GetStep() != SEQ_STEP_DISTORTION_STARTUPMODE_ACTION_WAIT;
}

enMCErrCode CSeqIntrinsic30::CheckPowerVoltage()
{
	auto err = MCEC_OK;
...
void CSeqIntrinsic30::SetPowerVoltage()
{
	float fVolt = 0.0;
...
float CSeqIntrinsic30::GetPowerVoltage()
{
