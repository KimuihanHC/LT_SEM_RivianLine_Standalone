...
typedef enum MyEnum
{
	...
	SEQ_STEP_PEEL_OFF_STARTUP_STANDBY,
	SEQ_STEP_PEEL_OFF_STARTUP_COMPLETE,
	SEQ_STEP_PEEL_OFF_STARTUP_ERROR,

	// wait pos
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_START,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_READY_SYLINDER_UP,			//LensCover 원위치
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_READY_SYLINDER_UP_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FILMGRIPPER_SYLINDER_BACK,			//FilmGripper Back원위치.COVER OFF도 포함.(forward되어 있다면 COVER OFF(Open)진행)
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FILMGRIPPER_SYLINDER_BACK_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FILMGRIPPER_COVER_ON,				//COVER On(CLose) 원위치.
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FILMGRIPPER_COVER_ON_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FILMGRIPPER_SYLINDER_GRIP_OFF,		//FilmGripper OFF(Open).원위치 Blow도 포함 (Back 동작을 했다면 Blow발생).
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FILMGRIPPER_SYLINDER_GRIP_OFF_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_READY_MOVE_WORK_ZONE_CHECK,			//Work_Zone_Dtc 감지된 상태에서 [FlimGripper] Gripper Forward된 상태에서는 Move금지.
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_READY_MOVE_Y,						
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_READY_MOVE_Z,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_SOCKETSTATE_PCB_DETECT,				// 카메라 감지 않되는 작업 불가.
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_SOCKETSTATE_PCB_GRIPPER_UP,			// GRIP Up.
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_SOCKETSTATE_PCB_GRIPPER_UP_CHECK,	// .
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_SOCKETSTATE_PCB_GRIPPER_GRIP_ON,			// GRIP On(Close)
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_SOCKETSTATE_PCB_GRIPPER_GRIP_ON_CHECK,	// .
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_END,

	//BARCODE
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_BARCODE_START,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_BARCODE_MOVE_WORK_ZONE_CHECK,		//Work_Zone_Dtc 감지된 상태에서 [FlimGripper] Gripper Forward된 상태에서는 Move금지.
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_BARCODE_LOAD_MOVE_Y,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_BARCODE_LOAD_MOVE_Z,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_BARCODE_READ,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_BARCODE_READ_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_BARCODE_UNLOAD_MOVE_Z,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_BARCODE_END,

	//LENS COVER PUSH
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_START,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_MOVE_WORK_ZONE_CHECK,		//Work_Zone_Dtc 감지된 상태에서 [FlimGripper] Gripper Forward된 상태에서는 Move금지.
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_LOAD_MOVE_Y,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_LOAD_MOVE_Z,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_SYLINDER_DOWN,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_SYLINDER_DOWN_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_SYLINDER_UP,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_SYLINDER_UP_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_UNLOAD_MOVE_Z,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_LENSCOVERPUSH_END,

	//FILM GRIPPER
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_START,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_MOVE_WORK_ZONE_CHECK,		//Work_Zone_Dtc 감지된 상태에서 [FlimGripper] Gripper Forward된 상태에서는 Move금지.
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_LOAD_MOVE_Y,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_LOAD_MOVE_Z,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_COVER_SYLINDER_OPEN,			
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_COVER_SYLINDER_OPEN_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_READY_SYLINDER_GRIP_OFF,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_READY_SYLINDER_GRIP_OFF_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_SYLINDER_FORWARD,			
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_SYLINDER_FORWARD_CHECK,		
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_SYLINDER_GRIP_ON,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_SYLINDER_GRIP_ON_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_PEEL_OFF_MOVE_Z,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_PEEL_OFF_MULTI_MOVE_YZ,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_SYLINDER_BACK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_SYLINDER_BACK_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_SYLINDER_GRIP_OFF,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_SYLINDER_GRIP_OFF_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_COVER_SYLINDER_CLOSE,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_COVER_SYLINDER_CLOSE_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_SYLINDER_GRIP_ON_FLIMOFF,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_SYLINDER_GRIP_ON_CHECK_FLIMOFF,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_SYLINDER_AIR_BLOW,				//AirBlow 혹은 이온나이저(IZN10E)가 사용 될 수 있음.
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_UNLOAD_MOVE_Z,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_FLIMGRIPPER_END,

	//TESTER
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_TESTER_START,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_TESTER_MOVE_Y,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_TESTER_MOVE_Z,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_TESTER_RUN1,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_TESTER_RUN_CHECK1,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_TESTER_MOVE_Z1,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_TESTER_RUN2,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_TESTER_RUN_CHECK2,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_TESTER_STOP,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_TESTER_UNLOAD_MOVE_Z,
	SEQ_STEP_PEEL_OFF_STARTUP_LOAD_TESTER_END,

	//Unloading
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_START,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_TESTER_STOP,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_LENSCOVERPUSH_SYLINDER_UP,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_LENSCOVERPUSH_SYLINDER_UP_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_FILMGRIPPER_SYLINDER_BACK,				//COVER OFF도 포함.(forward되어 있다면 COVER OFF진행)
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_FILMGRIPPER_SYLINDER_BACK_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_FILMGRIPPER_COVER_CLOSE,				
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_FILMGRIPPER_COVER_CLOSE_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_FILMGRIPPER_SYLINDER_GRIP_OFF,			//Blow도 포함 (Back 동작을 했다면 Blow발생).
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_FILMGRIPPER_SYLINDER_GRIP_OFF_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_MOVE_Z,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_LOAD_MOVE_Y,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_LOAD_MOVE_Z,					//대기 위치 이동	
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_SOCKETSTATE_PCB_GRIPPER_GRIP_OFF,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_SOCKETSTATE_PCB_GRIPPER_GRIP_OFF_CHECK,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_SOCKETSTATE_PCB_GRIPPER_DOWN,
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_SOCKETSTATE_PCB_GRIPPER_DOWN_CHECK,	
	SEQ_STEP_PEEL_OFF_STARTUP_UNLOAD_END,
