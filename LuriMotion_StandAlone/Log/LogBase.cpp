...
CLogBase::CLogBase(LPCTSTR lpszServiceName) :
	m_nExpirePeriod(-1),
	m_bStart(FALSE),
...
void CLogBase::GetLogPathName(CTime& Time, CExString& strLogPathName)
{
...
void CLogBase::GetCSVPathName(CTime& Time, CExString& strCSVPathName)
{
	int nYear = Time.GetYear();
	int nMonth = Time.GetMonth();
	int nDay = Time.GetDay();
...
void CLogBase::UseCSVFile(BOOL bUse, LPCTSTR lpszCSVHeader)
{
	m_bUseCSVFile = bUse;
	m_strCSVHeader.Format(_T("%s\r\n"), lpszCSVHeader);
}

void CLogBase::UseTextFile(BOOL bUse)
{
	m_bUseTxtFile = bUse;
}

void CLogBase::UseMonthlySplitFolder(BOOL bUse)
{
...
BOOL CLogBase::OpenCSVFile(CExString& strCSVPathName)
{
	if (!m_bUseCSVFile)
		return TRUE;
...
void CLogBase::LogOut(LPCTSTR lpszId, LPCTSTR lpszFormat, ...)
{
...
void CLogBase::DeleteExpiredCSVFile()
{
...
void CLogBase::DeleteExpiredLogFile()
{
...
void CLogBase::CreateFolder(LPCTSTR lpszPath)
{
